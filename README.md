...
Current progress in the implementation of Battlezoo monster parts imbuements can be seen in the [checklist](https://github.com/Cuingamehtar/fvtt-pf2e-monster-parts/blob/master/checklist.md)
...
Please see the instructions and the example workflow on the [Wiki page](https://github.com/Cuingamehtar/fvtt-pf2e-monster-parts/wiki/Example-workflow-by-Z3DT)
