...
## Fixed
- Darkness imbuement dealing bludgeoning damage instead of cold
...
### Added
- Add a setting to automatically give monster parts to NPCs imported from compendium
- Add Earth Armor imbued property.
